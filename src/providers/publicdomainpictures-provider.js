// src/providers/publicdomainpictures-provider.js
import BaseProvider from './base-provider.js';

class PublicDomainPicturesProvider extends BaseProvider {
    constructor(config, emitter) {
        super(config, emitter);
        this.providerName = 'PublicDomainPictures';
    ...
    async fetchImageUrls(query, page, options = {}) {
        ...
        try {
            ...
            await page.waitForSelector('div.thumbnail_container', { timeout: 20000 });
            
            // Get all image elements
            const imageElements = await page.$$('div.thumbnail_container a.thumbnail');
...
export default PublicDomainPicturesProvider;
